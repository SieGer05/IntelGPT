...
const MessageItem = ({ message }) => {
   ...
   return (
      <div className="w-full py-4 px-4 group">
         <div className={`max-w-3xl mx-auto flex ${isAi ? 'justify-start' : 'justify-end'}`}>
            <div className={`
            ...
            `}>
               ...
               <div className={`prose prose-invert max-w-none leading-relaxed ${isAi ? 'text-left' : 'text-left'}`}>
               ...
               {isAi && message.sources && message.sources.length > 0 && (
                  <div className="mt-3 p-3 bg-[#303131] rounded-lg text-xs w-full self-start">
                     <span className="font-bold text-gray-400 block mb-1 uppercase tracking-wider">Sources :</span>
